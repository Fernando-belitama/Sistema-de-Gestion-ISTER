...
ClsEstudiante estu=new ClsEstudiante();
 int cont=0;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("ELIMINAR ESTUDIANTES");
...
for(int i=0;i<estudiantes.size();i++){
            ...
            if(pro.getId()==estu.getId()){
                estudiantes.remove(pro);
                controlador.escribirObjeto("estudiantes.dat",estudiantes);
                JOptionPane.showMessageDialog(this,"Se ha eliminado el estudiante");
                limpiar();
                eliminar();
                actualizarTabla();
            }
  ...
  public void obtenerId(){
   ...
   public void eliminar(){
     ...
     DefaultTableModel model = (DefaultTableModel) tabla.getModel();
            String codigo= String.valueOf(model.getValueAt(tabla.getSelectedRow(),0));
            for(int i=0;i<estudiantes.size();i++){
